...
urlpatterns = [
    ...
    url(r'^regiondelete/$', region.region_del, name='region_del'),
    ...
    url(r'^branchdelete/$', branch.branch_del, name='branch_del'),
    ...
    url(r'^resourcedelete/$', resource.resource_del, name='resource_del'),
