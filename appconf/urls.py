...
urlpatterns = [
    ...
    url(r'^appownerdelete/$', appowner.appowner_del, name='appowner_del'),
    ...
    url(r'^productdelete/$', product.product_del, name='product_del'),
    ...
    url(r'^projectdelete/$', project.project_del, name='project_del'),
