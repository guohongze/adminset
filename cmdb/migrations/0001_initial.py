# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2017-02-19 15:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[(1, '\u4f7f\u7528\u4e2d'), (2, '\u672a\u4f7f\u7528'), (3, '\u7ef4\u4fee\u4e2d'), (3, '\u5176\u5b83')], max_length=30, null=True, verbose_name='\u8bbe\u5907\u72b6\u6001')),
                ('os', models.CharField(blank=True, max_length=50, null=True, verbose_name='\u64cd\u4f5c\u7cfb\u7edf')),
                ('vendor', models.CharField(blank=True, max_length=30, null=True, verbose_name='\u8bbe\u5907\u5382\u5546')),
